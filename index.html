    ...
    <!-- Portfolio End -->
      ...
      <div class="container-fluid py-5" id="skill">
        <div class="container">
           ...
           <div class="row">
               <div class="col-md-6 mb-2 text-center shadow-lg " >
                   <img src="img/certificat/mysql.jpg" alt="" style="height: 150px; ">
                   <h3 class="">Administrez vos bases de données avec mysql</h3>
               </div>

               <div class="col-md-6 text-center mb-2 shadow-lg">
                    <img src="img/certificat/HTML5.jpg" alt="" style="height: 150px;">
           ...
           <div class="row">
                <div class="col-md-6 mb-2 text-center shadow-lg " >
                    <img src="img/certificat/Ux.jpg" alt="" style="height: 150px; ">
                    <h3 class="">Appropriez-vous la démarche UX en pratique</h3>
                </div>

                <div class="col-md-6 text-center mb-2 shadow-lg">
                    <img src="img/certificat/fond.jpg" alt="" style="height: 150px;">
