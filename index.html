...
<body data-spy="scroll" data-target=".navbar" data-offset="51">
    ...
    <div class="container-fluid py-5" id="skill">
        <div class="container">
           ...
           <div class="row">
                <div class="col-md-6 mb-2 text-center shadow-lg " >
                    <img src="img/bootstrap.png" alt="" style="height: 80px;">
                    <h3>BOOTSTRAP</h3>
                    <p>Interfaces Utilisateurs agréables et responsives.</p>
                </div>
                <div class="col-md-6 mb-2 text-center shadow-lg " >
                    <img src="img/CSS3.png" alt="" style="height: 80px;">
                    <h3>CSS3</h3>
                    <p>Interfaces Utilisateurs agréables et responsives.</p>
                </div>
            </div>   
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-center mb-2 shadow-lg">
                    <img src="img/adobexd.png" alt="" style="height: 80px;">
                    <h3>ADOBE XD</h3>
        ...
        <div class="container">
            ...
            <div class="row pb-3">
                <div class="service-box col-lg-4 col-md-6 text-center mb-5">
                    ...
                    <p>Je suis en mesure de concevoir une application web sécuriser en intégrant toutes les fonctionnalités techniques sur mesure ou adapter des solutions techniques existantes en fonction du projet et de la demande du client.</p>
                </div>
